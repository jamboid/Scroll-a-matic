...
Snippets.Scroller = (function ($) {
	...
	setScroller = function (scroller, config) {
		...
		var thisScroller = scroller,
			...
			setupLayout = function() {
				...
				// Debug log
				cl("maxScroll: " + maxScroll + ", " + "Items to scroll: " + itemsToScroll );
				cl("Scroll width: " + scrlWidth + ", " + "Item Width: " + itemWidth);
				cl("Items to scroll: " + itemsToScroll + ", " + "Number of items: " + scrlItems.length + ", " + "Distance to scroll: " + moveWidth);
		...
		cl(scrollerConfig);
		cl(scrollerConfig.timeUnit);
		cl("timeUnit: " + timeUnit);
	...
	init = function () {
		setupScrollers();
		cl("Snippets.Scroller.init called");
	};
