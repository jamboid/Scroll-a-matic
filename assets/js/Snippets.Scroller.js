...
snippets.scroller = (function ($) {
    ...
    var setupScrollers = function() {
        ...
        setScroller = function (scroller, config) {
            var thisScroller = scroller,
                ...
                setupLayout = function () {
                    ...
                    // Debug log
                    snippets.utils.cl("maxScroll: " + maxScroll + ", " + "Items to scroll: " + itemsToScroll );
                    snippets.utils.cl("Scroll width: " + scrlWidth + ", " + "Item Width: " + itemWidth);
                    snippets.utils.cl("Items to scroll: " + itemsToScroll + ", " + "Number of items: " + scrlItems.length + ", " + "Distance to scroll: " + moveWidth);
            ...
            snippets.utils.cl(scrollerConfig);
            snippets.utils.cl(scrollerConfig.timeUnit);
            snippets.utils.cl("timeUnit: " + timeUnit);
        ...
        init = function () {
            setupScrollers();
            snippets.utils.cl("Snippets.Scroller.init called");
        };
